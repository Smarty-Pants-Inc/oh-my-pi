...
| --- | --- |
| `create` | Create a PR with an explicit title from an explicit already-published `--head` into explicit `base=main`; body/template/recovery/fill paths are excluded. |
