...
- Restored explicit per-spawn model selection for task and eval agents, with auth-aware fallback to the authenticated parent when a selected provider has no credentials.
