...
const OMP_SCOPE_BASE = {
	commit: "7e54061cbb1181dbc8dd7f0b37a1f12435a39e05",
	tree: "b9d4d17c4aa51e674cfbbc39fd3eb0aebfc2e3e8",
} as const;
...
export async function buildContextReleaseManifest(
	...
	const candidateInput =
		candidateOverride ?? (options?.scopeCoverage === undefined ? await loadActivationCandidates() : undefined);
