...
/**
 * Premium welcome screen with block-based Smarty-Pants SP logo and two-column layout.
 */
...
/** Block-grid Smarty-Pants SP brand mark shared by the welcome and setup surfaces. */
