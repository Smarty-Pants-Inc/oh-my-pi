...
const PATH_RULES: readonly PathRule[] = [
	...
	{
		pattern:
			/(?:^|\/)packages\/catalog\/src\/(?:build|effort|fireworks-model-id|hosts|model-cache|model-manager|model-thinking|models|openai-pricing|utils|variant-collapse)\.[cm]?[jt]s$/i,
		surface: "provider-mapping",
	},
