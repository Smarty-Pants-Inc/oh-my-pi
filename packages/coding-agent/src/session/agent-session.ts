...
export class AgentSession {
	...
	constructor(config: AgentSessionConfig) {
		...
		const maintenanceHost: SessionMaintenanceHost = {
			...
			runHandoff: (customInstructions, options, semanticDeliveryAcceptance, prepared) =>
				this.#handoff.handoff(customInstructions, options, semanticDeliveryAcceptance, prepared),
	...
	/**
	 * Generate a handoff document and continue from it in a fresh child session.
	 *
