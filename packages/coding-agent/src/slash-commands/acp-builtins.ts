import { ACP_BUILTIN_RESERVED_NAMES, lookupBuiltinSlashCommand } from "./builtin-registry";
...
export { ACP_BUILTIN_RESERVED_NAMES, ACP_BUILTIN_SLASH_COMMANDS } from "./builtin-registry";
