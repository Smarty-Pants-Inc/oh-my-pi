...
import {
	...
	type LocalCollabTransport,
	validateHerdrBridgeAddress,
} from "./agentd-local-transport";

export interface ManagedHerdrAgentdHostBridge extends RpcHerdrAgentdHostBridge {
	role: "host";
	managed: true;
	runtimeOwner: "agentd";
}
...
export class HerdrAgentdHostLifecycle {
	#context: CollabHostContext;
	#session: SessionSource;
	#bridge: ManagedHerdrAgentdHostBridge | undefined;
	...
	constructor(
		context: CollabHostContext,
		session: SessionSource,
		bridge: ManagedHerdrAgentdHostBridge,
