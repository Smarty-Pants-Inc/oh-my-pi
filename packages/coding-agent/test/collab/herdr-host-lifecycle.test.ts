...
import { HerdrCollabHostLifecycle, type ManagedHerdrHostBridge } from "../../src/collab/herdr-host-lifecycle";
...
function createLifecycle(
	...
	const managedBridge = bridge as ManagedHerdrHostBridge;
	managedBridge.role = "host";
	managedBridge.managed = true;
	managedBridge.runtimeOwner = "agentd";
	return new HerdrCollabHostLifecycle(createContext(sessionManager), session, managedBridge);
}
